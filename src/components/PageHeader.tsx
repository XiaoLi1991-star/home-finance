...
export function PageHeader({ title, back = false, action }: PageHeaderProps) {
  ...
  return (
    <header
      className="sticky top-0 z-20 -mx-4 px-4 pb-0.5 backdrop-blur-xl bg-surface-dim/80 supports-[backdrop-filter]:bg-surface-dim/60 transition-all duration-300"
      style={{
